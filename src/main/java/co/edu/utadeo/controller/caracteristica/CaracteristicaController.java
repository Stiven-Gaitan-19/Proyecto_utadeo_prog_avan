package co.edu.utadeo.controller.caracteristica;
...
public class CaracteristicaController extends JFrame {
	...
	public CaracteristicaController() {
		...
		btnEditar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 JFrame frame = new CaracteristicaEditController();
	                frame.setSize(582,490);
	                frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	                frame.setLocationRelativeTo(null);
	                frame.setVisible(true);
		...
		JLabel lblNewLabel = new JLabel("The Star Rover - Caracteristica");
		lblNewLabel.setBounds(140, 30, 311, 52);
