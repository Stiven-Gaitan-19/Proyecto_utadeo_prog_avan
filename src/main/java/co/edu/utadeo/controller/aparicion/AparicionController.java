...
public class AparicionController extends JFrame {
	private JTable table;

	/**
	 * Create the frame.
	 */
	public AparicionController() {
		...
		btnEditar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 JFrame frame = new AparicionEditController();
		...
		JLabel lblNewLabel = new JLabel("The Star Rover - Apariciones");
		lblNewLabel.setBounds(157, 30, 281, 52);
