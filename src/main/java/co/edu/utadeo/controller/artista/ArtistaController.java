...
public class ArtistaController extends JFrame {
	
	private JTable table;
	private ArtistaDAO artistaDAO;
	private String[] columnsTable = {"Code","Nombre", "Genero"};
	...
	public ArtistaController() {
		...
		btnEditar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JFrame frame = new ArtistaEditController();
                frame.setSize(582,490);
                frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                frame.setLocationRelativeTo(null);
                frame.setVisible(true);
		...
		JLabel lblNewLabel = new JLabel("The Star Rover - Artista");
		lblNewLabel.setBounds(169, 30, 281, 52);
	...
	private void initializeTable(JPanel panel){
		...
		Object[][] data = new String[artista.size()][3];
		for(int i=0; i<artista.size(); i++){
			data[i][0] = String.valueOf(artista.get(i).getCode());
			data[i][1] = String.valueOf(artista.get(i).getNombre());
			data[i][2] = String.valueOf(artista.get(i).getGeneroMusical().getNombre());
		}
