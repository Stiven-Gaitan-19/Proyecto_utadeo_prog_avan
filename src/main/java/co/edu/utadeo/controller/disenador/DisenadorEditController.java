...
public class DisenadorEditController extends JFrame {
	...
	public DisenadorEditController() {
		...
		textField.setBounds(244, 130, 200, 30);
		contentPane.add(textField);
		textField.setColumns(10);
		
		textField_1 = new JTextField();
		textField_1.setFont(new Font("Roboto Medium", Font.PLAIN, 14));
		textField_1.setColumns(10);
		textField_1.setBounds(244, 201, 200, 30);
		...
		comboBox.setBounds(244, 263, 200, 30);
