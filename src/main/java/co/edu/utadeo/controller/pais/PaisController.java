package co.edu.utadeo.controller.pais;
...
public class PaisController extends JFrame {
	...
	public PaisController() {
		...
		JLabel lblNewLabel = new JLabel("The Star Rover - Pais");
		lblNewLabel.setBounds(157, 11, 228, 52);
	...
	private void initializeTable(JPanel panel){
		...
		Object[][] data = new String[pais.size()][2];
		for(int i=0; i<pais.size(); i++){
			data[i][0] = String.valueOf(pais.get(i).getId());
			data[i][1] = String.valueOf(pais.get(i).getNombre());
		}
