package co.edu.utadeo.controller.coleccion;
...
public class ColeccionController extends JFrame {
	...
	public ColeccionController() {
		...
		btnEditar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 JFrame frame = new ColeccionEditController();
		...
		JLabel lblNewLabel = new JLabel("The Star Rover - Coleccion");
		lblNewLabel.setBounds(152, 30, 311, 52);
