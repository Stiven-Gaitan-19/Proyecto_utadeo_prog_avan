...
public class PortafolioController extends JFrame {
	...
	public PortafolioController() {
		...
		btnEditar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JFrame frame = new PortafolioEditController();
                frame.setSize(582,490);
                frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                frame.setLocationRelativeTo(null);
                frame.setVisible(true);
		...
		JLabel lblNewLabel = new JLabel("The Star Rover - Portafolio");
		lblNewLabel.setBounds(143, 11, 295, 52);
